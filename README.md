# ___***Self-Sanitize: Cognitive-Inspired In-Place Mitigation of LLM Harmful Responses***___
...
_**[Wenjie Fu](https://wjfu99.github.io)<sup>1</sup>, [Huandong Wang](https://scholar.google.com/citations?user=PNbioq0AAAAJ)<sup>2</sup>, Chen Gao<sup>2</sup>, [Guoan Wan]()<sup>4</sup>, [Junyao Gao](https://jeoyal.github.io/home/)<sup>3</sup>, Yong Li<sup>2</sup>, [Tao Jiang](https://scholar.google.com/citations?user=9BEmtIwAAAAJ)<sup>1</sup>**_
<!-- <br><br> -->
...
## Table of Contents
  ...
  - [___***Self-Sanitize: Cognitive-Inspired In-Place Mitigation of LLM Harmful Responses***___](#self-sanitize-cognitive-inspired-in-place-mitigation-of-llm-harmful-responses)
...
This repository contains the official implementation of the paper **"Self-Sanitize: Cognitive-Inspired In-Place Mitigation of LLM Harmful Responses"** (EMNLP 2026).
