...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--judge-file",
        type=str,
        default="reference/FastChat/fastchat/llm_judge/data/judge_prompts.jsonl",
    ...
    question_file = f"reference/FastChat/fastchat/llm_judge/data/mt_bench/question.jsonl"
    answer_dir = f"results/mt-bench/model_answers"
    ref_answer_dir = f"reference/FastChat/fastchat/llm_judge/data/mt_bench/reference_answer"
    ...
    if args.mode == "single":
        ...
        output_file = (
            f"results/mt-bench/model_judgment/{args.judge_model}_single.jsonl"
        )
        ...
        output_file = (
            f"results/mt-bench/model_judgment/{args.judge_model}_pair.jsonl"
        )
