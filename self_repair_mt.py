...
parser.add_argument("--output_dir", type=str, default="./results/mt-bench", help="The output directory for the dataset")
...
parser.add_argument("--max_memory", type=str, nargs="+", default=["0:60GB", "2:70GB", "4:70GB"], help="Max memory per GPU in format 'gpu_id:memory' (e.g., '0:60GB')")
parser.add_argument("--num_choices", type=int, default=1, help="The number of choices to generate")
...
# Load the datasets
questions = load_questions("reference/FastChat/fastchat/llm_judge/data/mt_bench/question.jsonl", None, None)

answer_file = f"{args.output_dir}/{args.model_name}/answers.jsonl"
        ...
        for i in range(args.num_choices):
            ...
            for j in range(len(question["turns"])):
                ...
                while unfinished_sequences:
                    outputs = model.generate(**inputs, past_key_values=past_key_values, max_new_tokens=1, output_hidden_states=True, return_dict_in_generate=True, temperature=temperature, do_sample=do_sample)
